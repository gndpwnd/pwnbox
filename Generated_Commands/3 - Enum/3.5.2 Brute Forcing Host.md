...
```bash
gobuster dir -u ${hosturl}:${web1} -w /usr/share/wordlists/dirb/big.txt -o /opt/THM/Whiterose/2-enum/web/gob_dir_host_big.md
```

```bash
gobuster dir -u ${hosturl}:${web1} -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -o /opt/THM/Whiterose/2-enum/web/gob_dir_host_2.3_med.md
```
