...
for tpl in ${tpls[@]}; do touch /opt/THM/Gallery/5-misc-tools/nuclei/${tpl}_${web1}_ip.md; docker run projectdiscovery/nuclei -v -t $tpl -u ${hosturl}:${web1} -o ${tpl}_${web1}_ip.md; done
```
