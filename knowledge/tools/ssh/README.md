...
## ssh(1) &mdash; Linux manual page

    
        

[NAME](#NAME) | [SYNOPSIS](#SYNOPSIS) | [DESCRIPTION](#DESCRIPTION) | [AUTHENTICATION](#AUTHENTICATION) | [ESCAPE CHARACTERS](#ESCAPE_CHARACTERS) | [TCP FORWARDING](#TCP_FORWARDING) | [X11 FORWARDING](#X11_FORWARDING) | [VERIFYING HOST KEYS](#VERIFYING_HOST_KEYS) | [SSH-BASED VIRTUAL PRIVATE NETWORKS](#SSH-BASED_VIRTUAL_PRIVATE_NETWORKS) | [ENVIRONMENT](#ENVIRONMENT) | [FILES](#FILES) | [EXIT STATUS](#EXIT_STATUS) | [SEE ALSO](#SEE_ALSO) | [STANDARDS](#STANDARDS) | [AUTHORS](#AUTHORS) | [COLOPHON](#COLOPHON)
...
## [](#DESCRIPTION)DESCRIPTION          [top](#top_of_page)
       ...
       **-e ***escape_char*
               ...
               by a dot (‘.’) closes the connection; followed by control-
       ...
       **-O ***ctl_cmd*
               ...
               execution), “cancel” (cancel forwardings), “proxy”
               (connect to a running multiplexing master in proxy mode),
               “exit” (request the master to exit), and “stop” (request
       ...
       **-w ***local_tun*[:*remote_tun*]
               ...
               *tun*(4) devices between the client (*local_tun*) and the
               ...
               “any”.  See also the **Tunnel **and **TunnelDevice **directives in
               *ssh_config*(5).
...
## [](#AUTHENTICATION)AUTHENTICATION          [top](#top_of_page)
...
## [](#ESCAPE_CHARACTERS)ESCAPE CHARACTERS          [top](#top_of_page)
...
## [](#TCP_FORWARDING)TCP FORWARDING          [top](#top_of_page)
...
## [](#X11_FORWARDING)X11 FORWARDING          [top](#top_of_page)
...
## [](#VERIFYING_HOST_KEYS)VERIFYING HOST KEYS          [top](#top_of_page)
       ...
       to “yes”, a small ASCII graphic gets displayed on every login to a
...
## [](#SSH-BASED_VIRTUAL_PRIVATE_NETWORKS)SSH-BASED VIRTUAL PRIVATE NETWORKS          [top](#top_of_page)
...
## [](#STANDARDS)STANDARDS          [top](#top_of_page)
...
## [](#COLOPHON)COLOPHON          [top](#top_of_page)
       ...
       [http://www.openssh.com/portable.html](http://www.openssh.com/portable.html).  If you have a bug report
       for this manual page, see ⟨[http://www.openssh.com/report.html](http://www.openssh.com/report.html)⟩.
       This page was obtained from the tarball openssh-9.9p2.tar.gz
       fetched from
       ⟨[http://ftp.eu.openbsd.org/pub/OpenBSD/OpenSSH/portable/](http://ftp.eu.openbsd.org/pub/OpenBSD/OpenSSH/portable/)⟩ on
...
Pages that refer to this page:
    [stap-jupyter(1)](../man1/stap-jupyter.1.html), 
    [systemd-ssh-issue(1)](../man1/systemd-ssh-issue.1.html), 
    [systemd-ssh-proxy(1)](../man1/systemd-ssh-proxy.1.html), 
    [systemd-stdio-bridge(1)](../man1/systemd-stdio-bridge.1.html), 
    [tar(1)](../man1/tar.1.html), 
    [sd_bus_default(3)](../man3/sd_bus_default.3.html), 
    [environment.d(5)](../man5/environment.d.5.html), 
    [proc_sys_vm(5)](../man5/proc_sys_vm.5.html), 
    [user@.service(5)](../man5/user@.service.5.html), 
    [pty(7)](../man7/pty.7.html), 
    [pam_systemd(8)](../man8/pam_systemd.8.html), 
    [systemd-machined.service(8)](../man8/systemd-machined.service.8.html), 
    [systemd-ssh-generator(8)](../man8/systemd-ssh-generator.8.html)
