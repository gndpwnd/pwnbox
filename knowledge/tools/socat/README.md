...
## socat(1) &mdash; Linux manual page

    
        

[NAME](#NAME) | [SYNOPSIS](#SYNOPSIS) | [DESCRIPTION](#DESCRIPTION) | [OPTIONS](#OPTIONS) | [ADDRESS SPECIFICATIONS](#ADDRESS_SPECIFICATIONS) | [ADDRESS TYPES](#ADDRESS_TYPES) | [ADDRESS OPTIONS](#ADDRESS_OPTIONS) | [DATA VALUES](#DATA_VALUES) | [EXAMPLES](#EXAMPLES) | [DIAGNOSTICS](#DIAGNOSTICS) | [FILES](#FILES) | [SIGNALS](#SIGNALS) | [ENVIRONMENT VARIABLES](#ENVIRONMENT_VARIABLES) | [CREDITS](#CREDITS) | [VERSION](#VERSION) | [BUGS](#BUGS) | [SEE ALSO](#SEE_ALSO) | [AUTHOR](#AUTHOR) | [COLOPHON](#COLOPHON)
...
## [](#OPTIONS)OPTIONS          [top](#top_of_page)
       ...
       **-S<signals-bitmap>**
              ...
              the information about the signal into **socat**s log, but
...
## [](#ADDRESS_SPECIFICATIONS)ADDRESS SPECIFICATIONS          [top](#top_of_page)
...
## [](#ADDRESS_TYPES)ADDRESS TYPES          [top](#top_of_page)
...
## [](#ADDRESS_OPTIONS)ADDRESS OPTIONS          [top](#top_of_page)
       ...
       **fips   **Enables FIPS mode if compiled in. For info about the FIPS
              ...
              [http://oss-institute.org/fips-faq.html](http://oss-institute.org/fips-faq.html).  This mode might
...
## [](#DATA_VALUES)DATA VALUES          [top](#top_of_page)
...
## [](#EXAMPLES)EXAMPLES          [top](#top_of_page)
       ...
       **socat \**
              ...
              **socat**s TCP procedures and change the socket type to
       ...
       **socat - \**
              **TCP:<server>:10021,reuseaddr,socktype=6,protocol=33,fork**
              ...
              in **socat**, however this example shows how use **socat**s TCP
...
## [](#DIAGNOSTICS)DIAGNOSTICS          [top](#top_of_page)
...
## [](#SIGNALS)SIGNALS          [top](#top_of_page)

       SIGUSR1:
              Causes logging of current transfer statistics.
              See also option --statistics

## [](#ENVIRONMENT_VARIABLES)ENVIRONMENT VARIABLES          [top](#top_of_page)
...
## [](#CREDITS)CREDITS          [top](#top_of_page)

       The work of the following groups and organizations was invaluable
       for this project:

       The *FSF* (GNU, [http://www.fsf.org/)](http://www.fsf.org/)) project with their free and
       portable development software and lots of other useful tools and
       libraries.

       The *Linux developers community* ([http://www.linux.org/](http://www.linux.org/)) for
       providing a free, open source operating system.

       The *Open Group* ([http://www.unix-systems.org/](http://www.unix-systems.org/)) for making their
       standard specifications available on the Internet for free.

## [](#VERSION)VERSION          [top](#top_of_page)
...
## [](#SEE_ALSO)SEE ALSO          [top](#top_of_page)
       ...
       **nc**(1), **rinetd**(8), **openssl**(1), **stunnel**(8), **rlwrap**(1), [setsid(1)](../man1/setsid.1.html)
...
## [](#COLOPHON)COLOPHON          [top](#top_of_page)
       ...
       ⟨[http://www.dest-unreach.org/socat/](http://www.dest-unreach.org/socat/)⟩.  It is not known how to
       report bugs for this man page; if you know, please send a mail to
       man-pages@man7.org.  This page was obtained from the tarball
       socat-1.8.0.3.tar.gz fetched from
       ⟨[http://www.dest-unreach.org/socat/download/](http://www.dest-unreach.org/socat/download/)⟩ on 2025-08-11.  If
...
Pages that refer to this page:
    [systemd-socket-proxyd(8)](../man8/systemd-socket-proxyd.8.html)
